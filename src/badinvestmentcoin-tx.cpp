...
static void SetupBadinvestmentcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " badinvestmentcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  badinvestmentcoin-tx [options] <hex-tx> [commands]  Update hex-encoded badinvestmentcoin transaction\n" +
            "or:     badinvestmentcoin-tx [options] -create [commands]   Create hex-encoded badinvestmentcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded badinvestmentcoin transaction
