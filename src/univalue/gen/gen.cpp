...
static void outputEscape()
{
	printf(	"// Automatically generated file. Do not modify.\n"
		"#ifndef BADINVESTMENTCOIN_UNIVALUE_UNIVALUE_ESCAPES_H\n"
		"#define BADINVESTMENTCOIN_UNIVALUE_UNIVALUE_ESCAPES_H\n"
	...
	printf(	"};\n"
		"#endif // BADINVESTMENTCOIN_UNIVALUE_UNIVALUE_ESCAPES_H\n");
}
