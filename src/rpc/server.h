...
#ifndef BADINVESTMENTCOIN_RPC_SERVER_H
#define BADINVESTMENTCOIN_RPC_SERVER_H
...
/**
 * Badinvestmentcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
#endif // BADINVESTMENTCOIN_RPC_SERVER_H
