...
#ifndef BADINVESTMENTCOIN_INTERFACES_NODE_H
#define BADINVESTMENTCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a badinvestmentcoin node (badinvestmentcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BADINVESTMENTCOIN_INTERFACES_NODE_H
