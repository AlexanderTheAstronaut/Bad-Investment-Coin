...
#ifndef BADINVESTMENTCOIN_WALLET_WALLET_H
#define BADINVESTMENTCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this badinvestmentcoin node, and set to 0 for transactions that were created
...
#endif // BADINVESTMENTCOIN_WALLET_WALLET_H
