...
#ifndef BADINVESTMENTCOIN_TEST_SCRIPTNUM10_H
#define BADINVESTMENTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Badinvestmentcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BADINVESTMENTCOIN_TEST_BIGNUM_H
