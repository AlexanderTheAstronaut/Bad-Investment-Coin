...
{
    BOOST_CHECK(TestSplitHost("www.badinvestmentcoincore.org", "www.badinvestmentcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.badinvestmentcoincore.org]", "www.badinvestmentcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.badinvestmentcoincore.org:80", "www.badinvestmentcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.badinvestmentcoincore.org]:80", "www.badinvestmentcoincore.org", 80));
