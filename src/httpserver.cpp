...
{
    RenameThread("badinvestmentcoin-http");
...
{
    RenameThread("badinvestmentcoin-httpworker");
    queue->Run();
}
...
void StopHTTPServer()
{
    ...
    if (eventBase) {
        ...
        // (see discussion in https://github.com/badinvestmentcoin/badinvestmentcoin/pull/6990)
