    ...
    mapper(0)
{
    ...
    ui->badinvestmentcoinAtStartup->setToolTip(ui->badinvestmentcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->badinvestmentcoinAtStartup->setText(ui->badinvestmentcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBadinvestmentcoinConfButton->setToolTip(ui->openBadinvestmentcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BadinvestmentcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->badinvestmentcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBadinvestmentcoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openBadinvestmentcoinConf())
