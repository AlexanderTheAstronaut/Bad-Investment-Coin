...
#ifndef BADINVESTMENTCOIN_QT_RPCCONSOLE_H
#define BADINVESTMENTCOIN_QT_RPCCONSOLE_H
...
/** Local Badinvestmentcoin RPC console. */
...
#endif // BADINVESTMENTCOIN_QT_RPCCONSOLE_H
