...
#ifndef BADINVESTMENTCOIN_QT_PAYMENTSERVER_H
#define BADINVESTMENTCOIN_QT_PAYMENTSERVER_H

// This class handles payment requests from clicking on
// badinvestmentcoin: URIs
//
...
#endif // BADINVESTMENTCOIN_QT_PAYMENTSERVER_H
