...
#ifndef BADINVESTMENTCOIN_QT_SENDCOINSDIALOG_H
#define BADINVESTMENTCOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending badinvestmentcoins */
...
#endif // BADINVESTMENTCOIN_QT_SENDCOINSDIALOG_H
