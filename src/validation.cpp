...
#if defined(NDEBUG)
# error "Badinvestmentcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Badinvestmentcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("badinvestmentcoin-scriptch");
