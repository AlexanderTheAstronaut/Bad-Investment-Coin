...
"""Verify that starting badinvestmentcoin with -h works as expected."""

from test_framework.test_framework import BadinvestmentcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(BadinvestmentcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start badinvestmentcoin with -h for help text")
        ...
        self.log.info("Start badinvestmentcoin with -version for version information")
        ...
        self.log.info("Start badinvestmentcoind with -fakearg to make sure it does not start")
