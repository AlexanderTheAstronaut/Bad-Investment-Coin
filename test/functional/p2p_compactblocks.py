...
# TestP2PConn: A peer we use to send messages to badinvestmentcoind, and store responses.
...
class CompactBlocksTest(BadinvestmentcoinTestFramework):
    ...
    # This test actually causes badinvestmentcoind to (reasonably!) disconnect us, so do this last.
    ...
    # badinvestmentcoind's choice of nonce.
    ...
    # Test that badinvestmentcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for badinvestmentcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # badinvestmentcoind will not send blocktxn responses for blocks whose height is
