Badinvestmentcoin Core version 0.13.2 is now available from:

  <https://badinvestmentcoin.org/bin/badinvestmentcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update badinvestmentcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow badinvestmentcoin-tx to create v2 transactions (btcdrak)
