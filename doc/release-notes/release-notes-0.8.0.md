Badinvestmentcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/badinvestmentcoin/files/Badinvestmentcoin/badinvestmentcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Badinvestmentcoin
...
New/changed settings (command-line or badinvestmentcoin.conf file)
--------------------------------------------------------
