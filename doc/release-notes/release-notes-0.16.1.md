Badinvestmentcoin Core version 0.16.1 is now available from:

  <https://badinvestmentcoincore.org/bin/badinvestmentcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting badinvestmentcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure badinvestmentcoind processes are cleaned up when tests end (sdaftuar)
