Badinvestmentcoin Core version 0.10.4 is now available from:

  <https://badinvestmentcoin.org/bin/badinvestmentcoin-core-0.10.4/>
...
- #6953 `43c2789` Split badinvestmentcoin-tx into its own package
- #6953 `dfe0d4d` Include badinvestmentcoin-tx binary on Debian/Ubuntu
