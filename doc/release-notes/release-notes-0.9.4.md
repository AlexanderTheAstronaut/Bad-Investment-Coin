Badinvestmentcoin Core version 0.9.4 is now available from:

  https://badinvestmentcoin.org/bin/0.9.4/
...
this update is incompatible with the Badinvestmentcoin system and could lead to consensus
forks.

Badinvestmentcoin Core released binaries from https://badinvestmentcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~badinvestmentcoin/+archive/ubuntu/badinvestmentcoin
- A third-party or self-compiled Badinvestmentcoin Core

upgrade to Badinvestmentcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
