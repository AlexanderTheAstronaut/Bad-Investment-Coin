Badinvestmentcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/badinvestmentcoin/files/Badinvestmentcoin/badinvestmentcoin-0.5.4/
...
http://gitorious.org/badinvestmentcoin/badinvestmentcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Badinvestmentcoin-Qt notifications under Growl 1.3.
Increase required age of Badinvestmentcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBadinvestmentcoin properly when installing Badinvestmentcoin-Qt over it. (Windows)
