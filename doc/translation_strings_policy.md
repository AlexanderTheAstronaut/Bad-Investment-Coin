...
This document provides guidelines for internationalization of the Badinvestmentcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `badinvestmentcoin_en.ts` remains unchanged.
